# -*- coding: utf-8 -*-
"""
Created on Sat Nov 28 14:06:39 2020
...
while (tracei > 0 and tracej > 0):
    ...
    if (tracei > 0 and tracej > 0 and main_matrix[tracei][tracej] == main_matrix[tracei - 1][tracej - 1] + check_matrix[tracei - 1][
        tracej - 1]):
    ...
    elif (tracei > 0 and main_matrix[tracei][tracej] == main_matrix[tracei - 1][tracej] + gap):
        aligned_1 = seq1[tracei - 1] + aligned_1
        aligned_2 = "*" + aligned_2
